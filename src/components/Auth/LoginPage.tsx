      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 w-full max-w-sm overflow-hidden">
        ...
        <div className="p-8">
          ...
          <button
            ...
            className="w-full py-2.5 border border-slate-200 text-slate-700 text-sm font-medium rounded-lg hover:bg-slate-50 flex items-center justify-center gap-2 transition-colors mt-2"
          >
